...
type CreateWhiteBlackIpRuleRequestBody struct {
	...
	TimeMode *CreateWhiteBlackIpRuleRequestBodyTimeMode `json:"time_mode,omitempty"`
...
type CreateWhiteBlackIpRuleRequestBodyTimeMode struct {
	value string
}

type CreateWhiteBlackIpRuleRequestBodyTimeModeEnum struct {
	PERMANENT CreateWhiteBlackIpRuleRequestBodyTimeMode
	CUSTOMIZE CreateWhiteBlackIpRuleRequestBodyTimeMode
}

func GetCreateWhiteBlackIpRuleRequestBodyTimeModeEnum() CreateWhiteBlackIpRuleRequestBodyTimeModeEnum {
	return CreateWhiteBlackIpRuleRequestBodyTimeModeEnum{
		PERMANENT: CreateWhiteBlackIpRuleRequestBodyTimeMode{
			value: "permanent",
		},
		CUSTOMIZE: CreateWhiteBlackIpRuleRequestBodyTimeMode{
...
func (c CreateWhiteBlackIpRuleRequestBodyTimeMode) Value() string {
	return c.value
}

func (c CreateWhiteBlackIpRuleRequestBodyTimeMode) MarshalJSON() ([]byte, error) {
	return utils.Marshal(c.value)
}

func (c *CreateWhiteBlackIpRuleRequestBodyTimeMode) UnmarshalJSON(b []byte) error {
