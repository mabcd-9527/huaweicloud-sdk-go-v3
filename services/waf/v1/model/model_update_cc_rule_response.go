...
type UpdateCcRuleResponse struct {
	...
	Action *UpdateCcRuleResponseBodyAction `json:"action,omitempty"`
...
func (o UpdateCcRuleResponse) String() string {
	...
	if err != nil {
		return "UpdateCcRuleResponse struct{}"
	}

	return strings.Join([]string{"UpdateCcRuleResponse", string(data)}, " ")
}
...
type UpdateCcRuleResponseTagTypeEnum struct {
	IP     UpdateCcRuleResponseTagType
	COOKIE UpdateCcRuleResponseTagType
	HEADER UpdateCcRuleResponseTagType
	OTHER  UpdateCcRuleResponseTagType
	POLICY UpdateCcRuleResponseTagType
	DOMAIN UpdateCcRuleResponseTagType
	URL    UpdateCcRuleResponseTagType
}

func GetUpdateCcRuleResponseTagTypeEnum() UpdateCcRuleResponseTagTypeEnum {
	return UpdateCcRuleResponseTagTypeEnum{
		IP: UpdateCcRuleResponseTagType{
			value: "ip",
		},
		COOKIE: UpdateCcRuleResponseTagType{
...
func (c UpdateCcRuleResponseTagType) Value() string {
	return c.value
}
