...
// UpdateIgnoreRuleHitNumResponse Response Object
type UpdateIgnoreRuleHitNumResponse struct {
...
func (o UpdateIgnoreRuleHitNumResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateIgnoreRuleHitNumResponse struct{}"
	}

	return strings.Join([]string{"UpdateIgnoreRuleHitNumResponse", string(data)}, " ")
}
