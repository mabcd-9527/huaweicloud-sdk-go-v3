...
// BatchCreateCustomRuleResponse Response Object
type BatchCreateCustomRuleResponse struct {
...
func (o BatchCreateCustomRuleResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "BatchCreateCustomRuleResponse struct{}"
	}

	return strings.Join([]string{"BatchCreateCustomRuleResponse", string(data)}, " ")
}
