...
type BatchCreateCcRuleRequestBody struct {
...
func (o BatchCreateCcRuleRequestBody) String() string {
	...
	if err != nil {
		return "BatchCreateCcRuleRequestBody struct{}"
	}

	return strings.Join([]string{"BatchCreateCcRuleRequestBody", string(data)}, " ")
}

type BatchCreateCcRuleRequestBodyTagType struct {
	value string
}

type BatchCreateCcRuleRequestBodyTagTypeEnum struct {
	IP     BatchCreateCcRuleRequestBodyTagType
	COOKIE BatchCreateCcRuleRequestBodyTagType
	HEADER BatchCreateCcRuleRequestBodyTagType
	OTHER  BatchCreateCcRuleRequestBodyTagType
	POLICY BatchCreateCcRuleRequestBodyTagType
	DOMAIN BatchCreateCcRuleRequestBodyTagType
	URL    BatchCreateCcRuleRequestBodyTagType
}

func GetBatchCreateCcRuleRequestBodyTagTypeEnum() BatchCreateCcRuleRequestBodyTagTypeEnum {
	return BatchCreateCcRuleRequestBodyTagTypeEnum{
		IP: BatchCreateCcRuleRequestBodyTagType{
			value: "ip",
		},
		COOKIE: BatchCreateCcRuleRequestBodyTagType{
...
func (c BatchCreateCcRuleRequestBodyTagType) Value() string {
	return c.value
}

func (c BatchCreateCcRuleRequestBodyTagType) MarshalJSON() ([]byte, error) {
	return utils.Marshal(c.value)
}

func (c *BatchCreateCcRuleRequestBodyTagType) UnmarshalJSON(b []byte) error {
