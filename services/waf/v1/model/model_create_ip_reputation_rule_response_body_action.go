...
func (o CreateIpReputationRuleResponseBodyAction) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateIpReputationRuleResponseBodyAction struct{}"
	}

	return strings.Join([]string{"CreateIpReputationRuleResponseBodyAction", string(data)}, " ")
}
