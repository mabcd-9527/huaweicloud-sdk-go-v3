...
func (o UpdateAnticrawlerRuleRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateAnticrawlerRuleRequest struct{}"
	}

	return strings.Join([]string{"UpdateAnticrawlerRuleRequest", string(data)}, " ")
}
