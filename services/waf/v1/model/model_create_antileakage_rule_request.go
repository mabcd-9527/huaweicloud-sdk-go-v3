...
func (o CreateAntileakageRuleRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateAntileakageRuleRequest struct{}"
	}

	return strings.Join([]string{"CreateAntileakageRuleRequest", string(data)}, " ")
}
