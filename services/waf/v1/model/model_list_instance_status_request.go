...
// ListInstanceStatusRequest Request Object
...
func (o ListInstanceStatusRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListInstanceStatusRequest struct{}"
	}

	return strings.Join([]string{"ListInstanceStatusRequest", string(data)}, " ")
}
