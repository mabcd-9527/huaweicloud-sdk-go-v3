...
// CreateIpReputationRuleResponse Response Object
type CreateIpReputationRuleResponse struct {
...
func (o CreateIpReputationRuleResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateIpReputationRuleResponse struct{}"
	}

	return strings.Join([]string{"CreateIpReputationRuleResponse", string(data)}, " ")
}
