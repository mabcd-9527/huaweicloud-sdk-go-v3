...
// DeleteAutoSqlLimitingRequest Request Object
type DeleteAutoSqlLimitingRequest struct {
...
func (o DeleteAutoSqlLimitingRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "DeleteAutoSqlLimitingRequest struct{}"
	}

	return strings.Join([]string{"DeleteAutoSqlLimitingRequest", string(data)}, " ")
}
